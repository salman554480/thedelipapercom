        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav list-navbar m-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="<?php echo $website_url ?>/" id="navbarDropdown"
                        role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Products
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="wax-paper.php">Wax Paper</a>
                        <a class="dropdown-item" href="<?php echo $website_url ?>/">Butcher Paper</a>
                        <a class="dropdown-item" href="<?php echo $website_url ?>/">Food Wrapping Paper</a>
                        <a class="dropdown-item" href="<?php echo $website_url ?>/">Paper Bags</a>
                        <a class="dropdown-item" href="<?php echo $website_url ?>/">Gift Wrapping Paper</a>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo $website_url ?>/get-quote.php">Get a Quote</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo $website_url ?>/blog.php">Blog</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo $website_url ?>/contact-us.php">Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo $website_url ?>/portfolio.php">Portfolio</a>
                </li>
            </ul>
    ...
    <section class="product-img-section">
        <div class="container-fluid">
            <div class="row ml-5 mr-5 mt-5 pt-5 justify-content-center">
                ...
                <div class="col-xl-6 col-lg-8 col-md-8 col-12 mt-5 flex-padding">
                    <div class="d-flex align-items-center gap-img">
                        ...
                        <div class="row justify-content-start quote-content ml-5">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group mb-0">
                                    ...
                                    <select class="form-control input-field " required="required">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" class="form-control input-field" name="" id="">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group mb-0">
                                    <label for="">Upload Logo File</label>
                                    <input type="file" class="form-control input-field" name="" id="">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group mb-0">
                                    <label for="">For Custom size / More information</label>
                                    <textarea name="" class="form-control input-field" rows="3" placeholder="Type Here"
                                        id=""></textarea>
                                </div>
                            </div>
                            <div class="col-xl-6">
            ...
            <div class="row mt-5 ml-5 mr-5">
                <div class="col-xl-6 flex-padding">
                    ...
                    <ul class="pl-0 list-grease">
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Free shipping to
                                the
                                United States, Canada,
                                and Mexico.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Process printing in
                                1, 2, or 4 colors.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Full ink coverage
                                is
                                possible.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; All are available
                                in
                                both standard and
                                customized sizes.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; The product is 100%
                                compostable and
                                recyclable.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Paper stocks are
                                available in white or Kraft
                                brown.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Microwave-safe
                                heating.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Freezer-friendly
                                storage</a>
                        </li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center mt-2">
                <div class="col-md-6 mt-2">
                    <ul class="pl-0 list-grease">
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Approved as safe
                                for
                                contact directly with
                                meals.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp;
                        ...
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; High quality, high
                                wet strength multipurpose
                                paper.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Ceases using oily
                                foods.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Manufactured
                                organically without the use of
                                coatings.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Printer ink made
                                from vegetables.</a>
                        </li>
                        <li>
                            <a href="<?php echo $website_url ?>/"><i class="bx bx-check"></i> &nbsp; Safe to use in the
                                oven, microwave, and
                                freezer.</a>
                        </li>
                    </ul>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6 mt-3 flex-padding-01">
                    <div class="card-wrapper border">
                        <div class="card-img position-relative">
                            ...
                            <img src="<?php echo $website_url ?>/assets/images/card-img-01.png" class="img-fluid w-100"
                                alt="">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6 mt-3 flex-padding-01">
                    <div class="card-wrapper border">
                        <div class="card-img position-relative">
                            ...
                            <img src="<?php echo $website_url ?>/assets/images/card-img-02.jpg" class="img-fluid w-100"
                                alt="">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6 mt-3 flex-padding-01">
                    <div class="card-wrapper border">
                        <div class="card-img position-relative">
                            ...
                            <img src="<?php echo $website_url ?>/assets/images/card-img-03.png" class="img-fluid w-100"
                                alt="">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6 mt-3 flex-padding-01">
                    <div class="card-wrapper border">
                        <div class="card-img position-relative">
                            ...
                            <img src="<?php echo $website_url ?>/assets/images/card-img-04.png" class="img-fluid w-100"
                                alt="">
                        </div>
                        <div class="card-body">
                ...
                ">
                    <form action="<?php echo $website_url ?>/">
                        <div class="row justify-content-start quote-content">
                            ...
                            <div class="col-xl-8">
                                <div class="bg-white p-3 mb-3 mt-2 border">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                            <label class="form-check-label" for="exampleCheck1">I'm not a robot</label>
