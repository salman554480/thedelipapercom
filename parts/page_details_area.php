                     ...
                     <div class="row justify-content-start quote-content">
                        <div class="col-xl-12 flex-padding">
                           <div class="form-group">
                              <input type="text" name="name" class="form-control input-field-form" placeholder="Name" required>
                           </div>
                        </div>
                        <div class="col-xl-12 flex-padding">
                           <div class="form-group">
                              <input type="text" name="phone" class="form-control input-field-form" placeholder="Phone">
                           </div>
                        </div>
                        <div class="col-xl-12 flex-padding">
                           <div class="form-group">
                              <input type="email" name="email" class="form-control input-field-form" placeholder="Email" required>
                           </div>
                        </div>
                        <div class="col-xl-12 flex-padding">
                           <div class="form-group mb-0">
                              <textarea name="message" class="form-control input-field-form" rows="8" placeholder="Message" required></textarea>
                           </div>
                        </div>
                        <div class="col-xl-12 mt-3">
                           <button type="submit" class="btn btn-send col-xl-5 col-8 d-flex justify-content-center mt-3 m-auto">Send</button>
                        </div>
                        <!-- Feedback Message -->
