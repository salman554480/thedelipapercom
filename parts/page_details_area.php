...
<?php } else if ($slug == "get-a-quote") { ?>
    ...
    <section class="testimonial-section choose-section">
        <img src="assets/images/dots-img.png" class="img-fluid dots-img" alt="">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-10 m-auto">
                    <p class="text-center para-choose">Discover The Deli Paper Company difference, where 24/7 support,
                        ...
                        difference, one innovative sheet at a time.</p>
                </div>
            </div>
        </div>
        <div class="container">
                        ...
                        <div class="col-xl-5 col-lg-10 col-md-10 col-12 flex-padding">
                            <div class="bg-white round-clock mt-3">
                                ...
                                <p class="mb-0">Any time, day or night, Deli Paper Company is here to assist you. If you
                                    need
                                    assistance, contact our support staff around-the-clock</p>
                        ...
                        <div class="col-xl-5 col-lg-10 col-md-10 col-12 flex-padding">
                            <div class="bg-white round-clock mt-3">
                                ...
                                <p class="mb-0">At Deli Paper Company, producing high-quality printing is not just our
                                    business; it is our passion. Our exceptional print solutions are our specialty</p>
                                <!-- <p class="mb-0">&nbsp;</p> -->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-5 col-lg-10 col-md-10 col-12 flex-padding">
                                <div class="bg-white round-clock mt-3">
                                    ...
                                    <p class="mb-0">Sustainability is a top priority for Deli Paper Company. Our
                                        creative method blends environmentally friendly materials.</p>
                                    <!-- <p class="mb-0">&nbsp;</p> -->
                                </div>
                            </div>
                        </div>
            ...
            <img src="assets/images/dots-img.png" class="img-fluid dots-img-01" alt="">
    </section>
            ...
            <div class="row pt-5 pb-5">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center flex-wrap logo-imgs">
                        <img src="assets/images/client-img-01.jpg" class="img-fluid" alt="">
                        <img src="assets/images/client-img-02.jpg" class="img-fluid" alt="">
                        <img src="assets/images/client-img-03.jpg" class="img-fluid" alt="">
                        <img src="assets/images/client-img-04.jpg" class="img-fluid" alt="">
                        <img src="assets/images/client-img-05.jpg" class="img-fluid" alt="">
                        <img src="assets/images/client-img-06.jpg" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row ml-5 mr-5 pl-4 pr-4">
                <div class="col-xl-8 col-lg-8 col-md-7 col-12 flex-padding">
                    <img src="assets/images/about-img.jpg" class="img-fluid w-100 h-450" alt="">
                </div>
