    ...
    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Contact</a>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <p class="tab-para mt-3">Heat Resistant Innovation: The Deli Paper presents a cutting-edge
                            selection of air fryer wax paper, specially designed to endure the heat of air frying. Our
                            greaseproof wax paper is not only heat resistant but also customizable, offering
                            personalized wax paper that brings a distinctive charm to your kitchen appliances.</p>
                        <p class="tab-para mt-3">Eco-Friendly Reusability: Choose sustainability with The Deli Paper’s
                            reusable wax paper. This greaseproof wax paper alternative is perfect for those seeking an
                            environmentally conscious option that doesn’t sacrifice quality or performance.</p>
                        <p class="tab-para mt-3">Customized Charm: Infuse your culinary space with individuality using
                            The Deli Paper’s personalized wax paper. Our bespoke designs provide a unique way to express
                            your style or brand, making every meal a personal statement.</p>
                        <p class="tab-para mt-3">Cost-Effective Durability: The Deli Paper ensures that our air fryer
                            wax paper is both durable and affordable. Enjoy high-quality greaseproof wax paper that
                            provides a reliable cooking surface without stretching your budget.</p>
                        <p class="tab-para mt-3">Versatile Utility: Our wax paper is a multipurpose marvel, acting as a
                            greaseproof barrier for a variety of kitchen tasks. Whether you’re wrapping, baking, or
                            preserving, our wax paper stands up to the challenge.</p>
                        <p class="tab-para mt-3">Wax Paper Wonders: The Deli Paper’s Air Fryer Essential The Deli
                            Paper’s air fryer wax paper is distinguished by its superior attributes:</p>
                        <div class="list-order ml-5">
                            <ol class="pl-0">
                                <li>
                                    <a href="#">Guaranteed Greaseproof: Our wax paper is thoroughly tested to ensure it
                                        is genuinely greaseproof, offering a dependable and clean solution for all your
                                        cooking and wrapping needs. </a>
                                </li>
                                <li class="mt-3">
                                    <a href="#">Exquisite Personalization: The <a href="#" class="text-deli"> Deli Paper
                                        </a> takes pride in providing personalized wax paper that enhances your brand’s
                                        identity or personal style, making every culinary creation a work of art. </a>
                                </li>
                                <li class="mt-3">
                                    <a href="#">Commitment to the Environment: With The Deli Paper, you’re choosing a
                                        product that’s kind to the earth. Our reusable wax paper is crafted from
                                        eco-friendly materials and is designed to last, reducing waste and promoting
                                        sustainability. </a>
                                </li>
                                <li class="mt-3">
                                    <a href="#">Adaptable for Any Occasion: Suitable for both home and professional
                                        settings, The Deli Paper’s air fryer wax paper is versatile enough to handle any
                                        task, ensuring your dishes are always presented beautifully. </a>
                                </li>
                                <li class="mt-3">
                                    <a href="#">User-Friendly Convenience: Our greaseproof wax paper comes in pre-cut
                                        sizes or rolls, tailored for your convenience, making kitchen prep quick and
                                        efficient. </a>
                                </li>
                            </ol>
                            <p class="tab-para">Step into the future of cooking with The Deli Paper’s air fryer wax
                                paper collection. It’s not just paper; it’s a premium, greaseproof, and eco-friendly
                                experience that transforms your food presentation.</p>
                        </div>
                    </div>
    ...
    <tr>
      ...
      <th scope="col">Handle</th>
            ...
            <div class="col-xl-4 flex-padding mt-3">
                <img src="assets/images/tab-img-01.png" class="img-fluid tab-img" alt="">
                ...
                <div class="position-relative">
                    ...
                    <img src="assets/images/tab-img-03.webp" class="img-fluid tab-img" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row ml-5 mr-5 mt-5">
            <div class="col-xl-6 col-lg-8 col-md-8 col-12 flex-padding">
                <div class="accordion-wrapper mt-3">
                    <div class="accordion-text d-flex justify-content-between align-items-center">
                        <h3>What is the Wax Paper logo's significance?</h3>
                        <i class="bx bx-chevron-right right-icon"></i>
                    </div>
                    <p class="accordion-para d-none">The Deli Paper’s Wax Paper logo is a symbol of our commitment to
                        sustainability and quality. It represents our promise to provide eco-friendly kitchen solutions
                        and stands as a seal of trust for our customers.</p>
                </div>
                <div class="accordion-wrapper mt-3">
                    <div class="accordion-text d-flex justify-content-between align-items-center">
                        <h3>How does Wax Paper enhance the air frying experience?</h3>
                        <i class="bx bx-chevron-right right-icon"></i>
                    </div>
                    <p class="accordion-para d-none">The Deli Paper air fryer wax paper is designed to be heat-resistant
                        and non-stick, which means your food cooks evenly and there’s no mess left behind. It simplifies
                        clean-up and promotes healthier cooking.
                    </p>
                </div>
                <div class="accordion-wrapper mt-3">
                    <div class="accordion-text d-flex justify-content-between align-items-center">
                        <h3>Why should I choose reusable wax paper?</h3>
                        <i class="bx bx-chevron-right right-icon"></i>
                    </div>
                    <p class="accordion-para d-none">The Deli reusable wax paper is an eco-friendly alternative that can
                        be washed and reused multiple times. It’s ideal for those looking to reduce waste and save money
            ...
            <div class="col-xl-6 col-lg-8 col-md-8 col-12 flex-padding">
                <div class="accordion-wrapper mt-3">
                    <div class="accordion-text d-flex justify-content-between align-items-center">
                        <h3>Can I get personalized wax paper for my kitchen?</h3>
                        <i class="bx bx-chevron-right right-icon"></i>
                    </div>
                    <p class="accordion-para d-none">Absolutely, The Deli Paper offers personalized wax paper to add a
                        unique touch to your kitchen creations. Whether it’s for wrapping gifts or preserving family
                        recipes, our custom-printed wax paper makes everything more special.
                    </p>
                </div>
                <div class="accordion-wrapper mt-3">
                    <div class="accordion-text d-flex justify-content-between align-items-center">
                        <h3>Is Wax Paper environmental friendly?</h3>
                        <i class="bx bx-chevron-right right-icon"></i>
                    </div>
                    <p class="accordion-para d-none">Yes, The Deli Paper’s Wax Paper is dedicated to sustainability. Our
                        products are designed to be reusable, reducing the need for single-use kitchen supplies and
                        helping you maintain an eco-conscious lifestyle.
                    </p>
                </div>
                <div class="accordion-wrapper mt-3">
                    <div class="accordion-text d-flex justify-content-between align-items-center">
                        <h3>Do you offer free shipping on butcher paper?</h3>
                        <i class="bx bx-chevron-right right-icon"></i>
                    </div>
                    <p class="accordion-para d-none">Yes, The Deli Paper Company offers free standard shipping on all
                        butcher paper orders, regardless of the order size or amount. For more information on our
                        shipping policies, including international shipping options, please visit our shipping policy
                        page.
                    </p>
