                            ...
                            <table id="datatablesSimple" class="table table-hover table-sm table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img height="40px" src="upload/admin/<?php echo $admin_image; ?>" alt="">
                                        </td>
                                                ...
                                                <li class="nav-item dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li> <a class="dropdown-item"
                                                                href="admin_view.php?del=<?php echo $admin_id; ?>">Delete</a>
                                                        </li>
                                                        <li>
                                                            <hr class="dropdown-divider" />
                                                        </li>
                                                        <li> <a class="dropdown-item"
                                                                href="admin_edit.php?edit=<?php echo $admin_id; ?>">Edit</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
