                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="card mb-1">
						...
						if (isset($_GET['edit'])) {
							...
							$select_admin = "SELECT * FROM admin WHERE admin_id='$edit_id'";
                        ...
                        <div class="card-body">
                            <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="admin_password" value="<?php echo $admin_password; ?>"
                                        class="form-control" required />
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Image*</label>
                                    <input type="file" name="admin_image" value="<?php echo $admin_image; ?>"
                                        class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label class="form-label">Role*</label>
                                    <input type="role" name="admin_role" value="<?php echo $admin_role; ?>"
                                        class="form-control" required />
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="admin_status" class="form-control" required>
                                        <option selected value="<?php echo $admin_status; ?>">
                                            <?php echo $admin_status; ?></option>
					...
					if (isset($_POST['insert_btn'])) {
						...
						$eadmin_role = $_POST['admin_role'];
						$eadmin_status = $_POST['admin_status'];
						...
						$update_admin = "UPDATE admin SET admin_name='$eadmin_name',admin_email='$eadmin_email',admin_password='$eadmin_password',admin_image='$eadmin_image',admin_role='$eadmin_role',admin_status='$eadmin_status' WHERE admin_id='$edit_id'";

						$run_admin = mysqli_query($conn, $update_admin);

						if ($run_admin == true) {
							//echo "data is inserted ";
							move_uploaded_file($tmp_name, "upload/admin/$eadmin_image");
