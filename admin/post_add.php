            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="card mb-1">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <h5 class="mb-0">
                                            <i class="fas fa-folder"></i> Category Selection
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="post_title" id="post_title" class="form-control" autofocus required />
                            ...
                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="meta_title" id="meta_title" class="form-control seo-field" maxlength="60">
                            ...
                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="meta_keyword" id="meta_keyword" class="form-control seo-field" maxlength="160">
                                                <div class="meta-counter">
                                                    <div class="progress mt-2" style="height: 6px;">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="meta_description" name="meta_description" class="form-control seo-field" maxlength="160" rows="3"></textarea>
                                                <div class="meta-counter">
                                                    <div class="progress mt-2" style="height: 6px;">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="post_tag" class="form-control" placeholder="tag1, tag2, tag3">
                                                <small class="form-text text-muted">
                        ...
                        <style>
                            /* Simplified Post Add Page Styles */
                            .card {
